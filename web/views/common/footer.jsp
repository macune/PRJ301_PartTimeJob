<%-- 
    Document   : footer
    Created on : Jun 18, 2026, 10:22:46 PM
    Author     : ADMIN
--%>

<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<footer class="custom-footer py-3 mt-auto border-top">
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-4 col-md-4">
                <h5 class="footer-title-custom">Về PartTimeJob</h5>
                <p class="footer-text-custom">
                    Nền tảng kết nối cơ hội việc làm bán thời gian nhanh chóng, uy tín và tối ưu dành riêng cho cộng đồng sinh viên.
                    Giúp tối ưu hóa lịch rảnh và nâng cao trải nghiệm thực tế.
                </p>
            </div>

            <div class="col-lg-4 col-md-4">
                <h5 class="footer-title-custom">Liên kết nhanh</h5>
                <ul class="list-unstyled d-flex flex-column gap-2 footer-text-custom">
                    <li><a href="${pageContext.request.contextPath}/index.jsp" class="footer-link-custom">Trang chủ tìm việc</a></li>
                    <li><a href="#" class="footer-link-custom">Danh mục ngành nghề</a></li>
